...
def createTable(conn):
	...
	with conn.cursor() as cursor:
                cursor.execute(f"""
                DROP TABLE IF EXISTS Staging_{TableName};
                CREATE UNLOGGED TABLE Staging_{TableName} (
                Year                INTEGER,
                CensusTract         NUMERIC,
                State               TEXT,
                County              TEXT,
...
""")
                print(f"Created Staging_{TableName}")
...
def load(conn, icmdlist):
	...
	with conn.cursor() as cursor:
		...
		print("Insertion into Staging complete")
